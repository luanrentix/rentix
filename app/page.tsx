...
export default function LoginPage() {
  ...
  async function handleLogin() {
    if (!email || !password) {
      setLoginErrorMessage("Informe e-mail e senha.");
      setLoginError(true);
      return;
    }
            ...
            <div className="w-full max-w-[525px] rounded-[30px] bg-white px-10 py-11 shadow-2xl">
              ...
              <div className="space-y-5">
                ...
                <button
                  ...
                  className="h-[60px] w-full rounded-2xl bg-[#ff4b00] text-base font-black text-white shadow-[0_14px_30px_rgba(255,75,0,0.28)] transition hover:bg-[#e94400] disabled:cursor-not-allowed disabled:opacity-70"
                >
